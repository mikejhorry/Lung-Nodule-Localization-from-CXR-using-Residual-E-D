...
do
 ...
 do python "JSRT_Nodule_Chest_Xray_kfold_train_test.py" -t $test -m $model -lr $lr -bs 1 -d "/data/mjhorry/Experiments/JSRT Nodule Segmentation/input/nodule_files/$test/crossval" -e 25 -a true -x $dim -k 0 -inf True -in True -od "/data/mjhorry/Experiments/JSRT Nodule Segmentation/input/nodule_files/NIH_SEG_A/crossval" -ext true
 done
done
